...
module.exports = {
    ...
    async execute(member) {
        ...
        const welcomeChannel = await getLogChannel(member.guild, "welcomeChannel") //welcome channel
        const logChannel = await getLogChannel(member.guild, "memberLog"); //log channel

        if (!welcomeChannel && !logChannel) return
        ...
        if (welcomeChannel) {
            ...
            try {
                ...
                console.log("Error sending welcome image:", error);
            }
